...
for c in range(1, 21):
    ...
    if (cor_cabelo == 'r' or cor_cabelo == 'R') and (cor_olhos != 'a' or cor_olhos != 'A'):
        ruivNAzul += 1
...
print(f'\n A percentagem de pessoas com olhos azuis entre todas as pessoas analizadas é de: {(OlhosAzuis / c) * 100}% ')
print(f'\n A quantidade de pessoas ruivas anlaizadas que não possui olhos azuis é de: {ruivNAzul}\n')